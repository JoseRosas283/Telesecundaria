...
namespace Telesecundaria.Repositories.Interfaces
{
    ...
    {
        Task<(bool exito, string mensaje, string claveToken, string tokenOriginal, string nombreTutor)>IniciarSesionAsync(LoginTutorRequest request, string ip, string userAgent);
